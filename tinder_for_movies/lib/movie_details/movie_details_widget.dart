...
class MovieDetailsWidget extends StatefulWidget {
  const MovieDetailsWidget({
    super.key,
    required this.recieveInfo,
  });

  final DocumentReference? recieveInfo;
...
class _MovieDetailsWidgetState extends State<MovieDetailsWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MoviesRecord>(
      stream: MoviesRecord.getDocument(widget!.recieveInfo!),
              ...
              title: Align(
                ...
                child: StreamBuilder<MoviesRecord>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final textMoviesRecord = snapshot.data!;

                    return Text(
                      textMoviesRecord.title,
                      style:
